...
<img src="../images/2022-02/image-20211225144013141.png" alt="image-20211225144013141" style="zoom: 33%;" />
...
<img src="../images/2022-02/image-20211225154727064.png" alt="image-20211225154727064" style="zoom:33%;" />
...
- rpc 时不要加锁，否则有可能发生死锁
  ...
  ![image-20211205105249811](../images/2022-02/image-20211205105249811.png)
...
![image-20220109170116160](../images/2022-02/image-20220109170116160.png)

![image-20220109182838354](../images/2022-02/image-20220109182838354.png)
...
![image-20220109191824727](../images/2022-02/image-20220109191824727.png)

![image-20220109191926745](../images/2022-02/image-20220109191926745.png)
...
1. 0 当选 leader, log [nil, 101]
   ...
   ![image-20220109195527651](../images/2022-02/image-20220109195527651.png)

   [nil, 101] commitIndex:1

   ![image-20220109195708846](../images/2022-02/image-20220109195708846.png)

   ![image-20220109195729639](../images/2022-02/image-20220109195729639.png)

   index1 apply 没毛病

2. rf0 leader 开始发生网络分区, 且上层服务再次期间调用 start()

   ![image-20220109200120066](../images/2022-02/image-20220109200120066.png)

3. rf1 rf2 同时 election timeout 

   ![image-20220109200421562](../images/2022-02/image-20220109200421562.png)

4. rf1 election timeout

   ![image-20220109200605813](../images/2022-02/image-20220109200605813.png)
   ...
   4. ![image-20220109202025754](../images/2022-02/image-20220109202025754.png)
...
![image-20220109203835984](../images/2022-02/image-20220109203835984.png)
...
![image-20220120014306611](../images/2022-02/image-20220120014306611.png)
